...
namespace Tetris3D
{
   ...
   public abstract class TetrisPiece
   {
      ...
      public Point[] getWestOrientation
      {
         get { return pointsForWestOrientation(); }
      }

      public Point[] getSouthOrientation
      {
         get { return pointsForSouthOrientation(); }
      }

      public Point[] getNorthOrientation
      {
         get { return pointsForNorthOrientation(); }
      }

      public Point[] getEastOrientation
      {
         get { return pointsForEastOrientation(); }
      }
   }
}
